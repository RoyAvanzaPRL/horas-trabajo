...
fun TrabajoEntity.toDomain() = Trabajo(id = id, nombre = nombre, simboloMoneda = simboloMoneda)

fun Trabajo.toEntity() = TrabajoEntity(id = id, nombre = nombre, simboloMoneda = simboloMoneda)
